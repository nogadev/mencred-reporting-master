            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <input type="text" id="new_company_name" class="form-control" placeholder="Nombre">
                    </div>
                </div>     
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="storeNewCompany();">Guardar</button>
            </div>
        </div>
    </div>
</div>
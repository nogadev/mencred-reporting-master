    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">INGRESO DE CHEQUE</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <input type="text" id="paycheck_amount" class="form-control" placeholder="Importe">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <textarea type="text" id="description_check" class="form-control" placeholder="Detalle"></textarea>
                    </div>
                </div>

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="setPaycheck();">GUARDAR</button>
            </div>
        </div>
    </div>
</div>
